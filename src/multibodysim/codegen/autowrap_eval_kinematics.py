...
from .artifacts import (
    autowrap_eval_kinematics_artifact_dir,
    load_function_from_metadata,
    read_metadata,
    write_metadata,
)
from .constants import BACKEND_NAME, GENERATED_EVALUATOR_ROOT
from .metadata import autowrap_eval_kinematics_cache_metadata
...
def load_autowrap_eval_kinematics(
    ...
    *,
    ...
    expected_metadata = autowrap_eval_kinematics_cache_metadata(dyn)
    artifact_dir = autowrap_eval_kinematics_artifact_dir(
        dyn,
...
def generate_autowrap_eval_kinematics(
    dyn,
    *,
    cache_root: Path | None = None,
) -> dict:
    ...
    metadata = autowrap_eval_kinematics_cache_metadata(dyn)
    data = symbolic_eval_kinematics_data(dyn)
