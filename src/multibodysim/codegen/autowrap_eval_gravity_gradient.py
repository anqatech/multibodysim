...
from .artifacts import (
    autowrap_eval_gravity_gradient_artifact_dir,
    load_function_from_metadata,
    read_metadata,
    write_metadata,
)
from .constants import BACKEND_NAME
from .metadata import autowrap_eval_gravity_gradient_cache_metadata
...
def load_autowrap_eval_gravity_gradient(
    dyn,
    *,
    cache_root: Path | None = None,
) -> dict | None:
    expected_metadata = autowrap_eval_gravity_gradient_cache_metadata(dyn)
    artifact_dir = autowrap_eval_gravity_gradient_artifact_dir(
        dyn,
    ...
    data = symbolic_eval_gravity_gradient_data(dyn)
...
def generate_autowrap_eval_gravity_gradient(
    dyn,
    *,
    cache_root: Path | None = None,
) -> dict:
    ...
    metadata = autowrap_eval_gravity_gradient_cache_metadata(dyn)
    data = symbolic_eval_gravity_gradient_data(dyn)
